...
import { holdOrder } from "@/lib/services/order-service";
import { holdOrderSchema } from "@/lib/validators/order.validators";
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    const result = await holdOrder(orderId, parsed.data.notes);
